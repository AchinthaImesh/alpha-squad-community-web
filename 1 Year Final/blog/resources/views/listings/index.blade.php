                    ...
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="/listings/{{ $listing['id'] }}"><img
                                    src="{{ $listing->image ? asset('storage/' . $listing->image) : asset('assets-blog/img/post-landscape-7.jpg') }}"
                            ...
                            <p id="para" class="mb-4 d-block" style="">{{ $listing['description'] }}</p>

                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="assets-blog/img/person-7.jpg" alt=""
                                        class="img-fluid">
